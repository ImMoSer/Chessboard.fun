...
- **Costs per Unit**:
  ...
  - **Repertoire Generator**: 50 PawnCoins per generation.
- **Replenishment**:
...
| **Rook** | ♜ | 2,500 | Paid / Elite |
| **Queen** | ♛ | 5,000 | Paid / Grandmaster |
...
- **Storage**: King tier includes advanced cloud storage synchronization for opening repertoires.
