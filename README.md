...
Lichess Puzzle Database: All puzzles in the application are based on the vast and high-quality Lichess puzzle database.
...
API: Lichess API for fetching user and club data.
...
Important Note on the GPLv3 License:
The use of a library under the GPLv3 license requires us to make the source code of our own project open and available under the same or a compatible license.

License Text: You can read the full text of the GPLv3 license here.
