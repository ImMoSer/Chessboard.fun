...
import { type AdvantageDifficulty, type AdvantageTheme } from '@/types/api.types'
      ...
      <div class="selection-sections">
        ...
        <div class="section">
          ...
          <div class="category-grid">
            <button
              v-for="theme in themesWithIcons"
              :key="theme.key"
              class="category-btn"
            ...
            >
              <span v-if="!theme.isSvg" class="cat-icon">
                {{
                  t(
                    `theoryEndings.categories.${getThemeTranslationKey(theme.key)}.icon`,
                    theme.key === 'auto' ? '✨' : '',
                  )
                }}
              </span>
              ...
              <span class="cat-name">{{
                t(`chess.themes.${getThemeTranslationKey(theme.key)}`)
              }}</span>
            </button>
          </div>
        </div>
