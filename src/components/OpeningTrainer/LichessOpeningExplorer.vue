...
<template>
    <div class="lichess-opening-explorer" :class="{ 'blurred': blurred }">
        ...
        <div class="table-container">
            ...
            <!-- Top Games Section -->
            <div v-if="stats && stats.topGames && stats.topGames.length > 0" class="top-games-section">
                <div class="section-divider">
                    <span class="divider-text">Top Master Games</span>
                </div>
                <div class="games-list">
                    <a v-for="game in stats.topGames" :key="game.id" :href="'https://lichess.org/' + game.id"
                        target="_blank" class="game-row">
                        <div class="game-info">
