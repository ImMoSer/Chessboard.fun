...
<template>
    <n-modal :show="true" preset="card" :style="{ width: '600px', borderRadius: '16px' }" class="settings-modal"
        :title="t('nav.openingExam')" :bordered="false" @close="$emit('close')">
        ...
        <template #footer>
            <n-button type="primary" size="large" block secondary strong class="start-btn exam-btn"
                @click="startSession">
                <template #icon>
                    <n-icon>
                        <PlayOutline />
